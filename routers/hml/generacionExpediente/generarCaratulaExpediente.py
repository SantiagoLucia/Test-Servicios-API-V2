...
uri_servicio = config["hml"]["uri_generacionExpediente"]

router = APIRouter()

@router.get("/test_servicios/hml/generacionExpediente/generarCaratulaExpediente", tags=["hml","generarCaratulaExpediente"])
