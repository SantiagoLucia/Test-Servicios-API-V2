...
@router.get("/test_servicios/hml/consultaExpediente/consultarCaratulaVariablePorNumeroExpedienteUsuario", tags=["hml","consultarCaratulaVariablePorNumeroExpedienteUsuario"])
